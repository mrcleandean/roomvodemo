...
const Button: FC<ButtonProps> = ({ onClick, text, Symbol = null }) => {
    return (
        <button onClick={onClick} className="relative h-[40px] rounded-[12px] py-[16px] px-[12px] overflow-hidden text-white hover:text-[#373C40] flex items-center gap-2 transition-all duration-200 font-inter font-medium">
            {Symbol && (
